...
public class CustomChatListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        usersLikedMessagesRef = FirebaseDatabase.getInstance().getReference().child(USERS_LIKED_MESSAGES).child(currentUserInfo.getUniqueID()).child(lectureInfo.getUniqueID());
